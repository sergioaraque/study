...
push.delete('/unsubscribe', zValidator('json', z.object({ endpoint: z.string().url() })), async (c) => {
  ...
  for (const doc of existing.documents) {
    await databases.deleteDocument(config.APPWRITE_DATABASE_ID, config.COL_PUSH_SUBSCRIPTIONS, doc.$id)
  }
